...
func (s *Service) Fetch(alias string) (string, error) {
...
func (s *Service) Create(url string, alias string) (int64, error) {
	id, err := s.repo.Store(Item{url, alias})
	if err != nil {
...
func (s *Service) Delete(alias string) error {
